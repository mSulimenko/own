...
void printHelp(){
    ...
    printf("-i --inversion -o --start <value>,<value> -e --end <value>,<value> <file_in> <file_out>\n");
    printf("-f --frame -o --rgb <value>,<value>,<value> -p --pattern <value> -t --thick <value> <file_in> <file_out>\n");
    printf("-r --rectangles -o --rgb <value>,<value>,<value> -s --rgb2 <value>,<value>,<value> -t --thick <value> <file_in> <file_out>\n");
    printf("-h --help -? - help\n");
}
...
//  drawCircle(&image, 200, 200, 150, 3, lnColor);
    ...
    new(&image);
    //reflection(&image, 50, 50, 250, 250, 1);
